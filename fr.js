...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
    'Créer une couleur avec la quantité de rouge, vert et bleu spécifiée. Toutes les valeurs doivent être comprises entre 0 et 100.';
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
    "Si la première valeur est vraie, alors exécuter le premier bloc d’instructions. Sinon, si la deuxième valeur est vraie, alors exécuter le deuxième bloc d'instructions.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
    "Si la première valeur est vraie, alors exécuter le premier bloc d’instructions. Sinon, si la deuxième valeur est vraie, alors exécuter le deuxième bloc d'instructions. Si aucune des valeurs n’est vraie, alors exécuter le dernier bloc d’instructions.";
...
Blockly.Msg.EXAMPLE_DESCRIPTION =
    'Définit un exemple avec un comportement attendu et réel';
Blockly.Msg.EXPAND_ALL = 'Étendre les bloc';
Blockly.Msg.EXPAND_BLOCK = 'Étendre le bloc';
...
Blockly.Msg.FUNCTION_PARAMETERS_LABEL = 'Quels paramètres reçoit votre fonction ?';
...
Blockly.Msg.FUNCTIONAL_TYPE_LABEL = 'Choisir le type...';
...
Blockly.Msg.FUNCTIONAL_RANGE_LABEL = 'Intervalle';
...
Blockly.Msg.LISTS_GET_INDEX_FROM_END = '# en partant de la fin';
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
    "Renvoie l’élément d'une liste situé à la position indiquée.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
    "Supprime et renvoie l’élément d'une liste situé à la position indiquée.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM =
    "Supprime et renvoie au hasard un élément d'une liste.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM =
    "Supprime l’élément d'une liste situé à la position indiquée";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM =
    "Supprime au hasard un élément d'une liste.";
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END =
    'obtenir la sous-liste depuis # en partant de la fin';
...
Blockly.Msg.LISTS_INDEX_OF_FIRST =
    'trouver la première apparition de l’élément';
...
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
    'Crée une liste contenant la valeur fournie répétée le nombre de fois indiqué.';
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM =
    'Insère l’élément dans une liste à la position indiquée.';
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM =
    'Insère au hasard l’élément dans une liste.';
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM =
    'Fixe l’élément dans une liste à la position indiquée.';
...
Blockly.Msg.LISTS_SPLIT_LIST_FROM_TEXT = 'générer une liste depuis le texte';
Blockly.Msg.LISTS_SPLIT_TEXT_FROM_LIST = 'générer un texte depuis la liste';
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
    'Unir une liste de textes en un seul texte, séparés par un séparateur.';
...
Blockly.Msg.MATH_CONSTRAIN_TITLE = 'contraindre %1 inférieur %2 supérieur %3';
...
Blockly.Msg.MATH_ONLIST_OPERATOR_MAX = 'valeur maximum de la liste';
Blockly.Msg.MATH_ONLIST_OPERATOR_MEDIAN = 'médiane de la liste';
Blockly.Msg.MATH_ONLIST_OPERATOR_MIN = 'valeur minimum de la liste';
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM =
    'Renvoyer un élément au hasard de la liste.';
...
Blockly.Msg.MATH_RANDOM_INT_HELPURL =
    'http://fr.wikipedia.org/wiki/G%C3%A9n%C3%A9rateur_de_nombres_al%C3%A9atoires';
Blockly.Msg.MATH_RANDOM_INT_TITLE = 'nombre entier aléatoire entre %1 et %2';
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
    'Renvoyer un nombre entier aléatoire entre les deux limites spécifiées, incluses.';
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_LN =
    'Renvoyer le logarithme népérien d’un nombre.';
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 =
    'Renvoyer le logarithme de base 10 d’un nombre.';
...
Blockly.Msg.PROCEDURES_DEFNORETURN_HELPURL =
    'http://en.wikipedia.org/wiki/Procedure_%28computer_science%29';
Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE = 'exécuter quelque chose';
Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE = 'pour';
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP = 'Crée une fonction qui ne génère pas de résultat.';
Blockly.Msg.PROCEDURES_DEFRETURN_DO = '';
Blockly.Msg.PROCEDURES_DEFRETURN_HELPURL =
    'http://en.wikipedia.org/wiki/Procedure_%28computer_science%29';
Blockly.Msg.PROCEDURES_DEFRETURN_PROCEDURE = 'exécuter quelque chose';
...
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING =
    'Attention : Cette fonction contient des paramètres en double.';
...
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_TITLECASE =
    'en Majuscules Au Début De Chaque Mot';
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_UPPERCASE = 'en MAJUSCULES';
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP =
    'Renvoie une copie du texte avec une combinaison differente de majuscules/minuscules.';
Blockly.Msg.TEXT_CHARAT_TITLE = '%2 dans le texte %1';
Blockly.Msg.TEXT_CHARAT_FROM_END = 'obtenir la lettre # (en partant de la fin)';
...
Blockly.Msg.TEXT_CHARAT_TOOLTIP = 'Renvoie la lettre située à la position spécifiée.';
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
    'Ajouter, supprimer ou réordonner les sections pour reconfigurer ce bloc de texte.';
Blockly.Msg.TEXT_GET_SUBSTRING_END_FROM_END =
    'jusqu’à la lettre # en partant de la fin';
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST =
    'obtenir le sous-texte depuis la première lettre';
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
    'obtenir le sous-texte depuis la lettre # en partant de la fin';
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START =
    'obtenir le sous-texte depuis la lettre #';
...
Blockly.Msg.TEXT_INDEXOF_OPERATOR_FIRST =
    'trouver la première apparition du texte';
...
Blockly.Msg.TEXT_PRINT_TOOLTIP =
    'Afficher le texte, le nombre ou autre valeur spécifiée.';
...
Blockly.Msg.TEXT_PROMPT_TYPE_NUMBER = 'demander un nombre à travers un message';
Blockly.Msg.TEXT_PROMPT_TYPE_TEXT = 'demander un texte à travers un message';
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
    'Renvoyer une copie du texte avec les espaces supprimés d’un ou des deux côtés.';
Blockly.Msg.UNUSED_CODE = 'Code non utilisé';
Blockly.Msg.VARIABLE = 'variable';
Blockly.Msg.VARIABLES_DEFAULT_NAME = 'élément';
Blockly.Msg.VARIABLES_GET_CREATE_SET = "Créer l'«ensemble %1»";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP =
    "Définit la valeur de cette variable pour qu’elle soit égale à la valeur d'entrée.";

// Custom blocks start here

Blockly.Msg.GRAB_TITLE = 'Prendre %1';
Blockly.Msg.GRAB_TOOLTIP = 'Prend l’objet';
Blockly.Msg.DROP_TITLE = 'Lâcher %1';
Blockly.Msg.DROP_TOOLTIP = 'Lâche l’objet';
Blockly.Msg.FEED_TITLE = 'Nourrir %1';
Blockly.Msg.FEED_TOOLTIP = 'Nourrit la boîte';
Blockly.Msg.BOX1_TITLE = 'Boîte 1';
Blockly.Msg.BOX1_TOOLTIP = '';
Blockly.Msg.EGG_TITLE ='Œuf';
Blockly.Msg.EGG_TOOLTIP = '';
Blockly.Msg.AGV_TITLE = 'VGA';
Blockly.Msg.AGV_TOOLTIP = '';
Blockly.Msg.ADULT_TITLE = 'Adulte';
Blockly.Msg.ADULT_TOOLTIP = '';
Blockly.Msg.COMPARTMENT_TITLE = 'Compartiment';
Blockly.Msg.COMPARTMENT_TOOLTIP = '';
Blockly.Msg.MOVE_TO_TITLE = 'Déplacer le VGA vers x%1';
Blockly.Msg.MOVE_TO_TOOLTIP = 'Déplacer le VGA vers les coordonnées';
Blockly.Msg.MOVE_TO_ITEM_TITLE = 'Déplacer le VGA vers %1';
Blockly.Msg.MOVE_TO_ITEM_TOOLTIP = 'Déplacer le VGA vers l’objet';
Blockly.Msg.MOVE_ITEM_TO_TITLE = 'Transporter %1';
Blockly.Msg.MOVE_ITEM_TO_TITLE1 = 'Vers %1';
Blockly.Msg.MOVE_ITEM_TO_TOOLTIP = 'Prends l’objet et le transporte vers les coordonnées.';
Blockly.Msg.MOVE_ITEM_TO_ITEM_TITLE = 'Transporter %1';
Blockly.Msg.MOVE_ITEM_TO_ITEM_TITLE1 = 'Vers %1';
Blockly.Msg.MOVE_ITEM_TO_ITEM_TOOLTIP = 'Prend l’objet et le transporte vers la boîte.';
Blockly.Msg.PUT_TITLE = 'Mettre %1';
Blockly.Msg.PUT_TITLE1 = 'Dans %1';
Blockly.Msg.PUT_TOOLTIP = 'Met l’objet dans la boîte.';
Blockly.Msg.TAKE_TITLE = 'Prendre %1';
Blockly.Msg.TAKE_TITLE1 = 'De %1';
Blockly.Msg.TAKE_TOOLTIP = 'Prend quelque chose de la boîte.';
Blockly.Msg.CHANGE_BOX_OF_ITEM_TITLE = 'Transférer %1';
Blockly.Msg.CHANGE_BOX_OF_ITEM_TITLE1 = 'De %1';
Blockly.Msg.CHANGE_BOX_OF_ITEM_TITLE2 = ' À %1';
Blockly.Msg.CHANGE_BOX_OF_ITEM_TITTOOLTIP = 'Transfère l’objet d’une boîte à une autre';
Blockly.Msg.ON_EVENT_TITLE = 'Quand %1';
Blockly.Msg.ON_EVENT_TOOLTIP = 'Jsp';
Blockly.Msg.LOGIC_TITLE = 'Logique';
Blockly.Msg.LOOPS_TITLE = 'Boucles';
Blockly.Msg.MATH_TITLE = 'Mathématiques';
Blockly.Msg.TEXT_TITLE = 'Texte';
Blockly.Msg.LISTS_TITLE = 'Listes';
Blockly.Msg.COLOR_TITLE = 'Couleur';
Blockly.Msg.VARIABLES_TITLE = 'Variables';
Blockly.Msg.FUNCTIONS_TITLE = 'Fonctions';
Blockly.Msg.INSECT_FARM_ELEMENTS_TITLE = 'Éléments de la ferme d’insectes';
Blockly.Msg.INSECT_FARM_FUNCTIONS_TITLE = 'Fonctions de la ferme d’insectes';
Blockly.Msg.INSECT_FARM_COMPLEX_FUNCTIONS_TITLE = 'Fonctions complexes de la ferme d’insectes';